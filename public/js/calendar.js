...
document.write('<tr style="background:#FF9900;font:12px Arial;color:#FFFFFF"><td align=center>Пн</td><td align=center>Вт</td><td align=center>Ср</td><td align=center>Чт</td><td align=center>Пт</td><td align=center>Сб</td><td align=center>Вс</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#FFC266" onclick="today()">Дата: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
...
var mn=new Array('Январь','Февраль','Март','Апрель','МаЙ','Июнь','Июльб','Август','Сентябрь','Октябрь','Ноябрь','Декабрь');
